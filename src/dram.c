...
void set_area2_access_bit(void)
{
  ABWCR = ABWCR | 0b00000100;
}

void set_DRAM_refresh_cycle(void)
{
  RTCOR = 150;
}
...
void set_DRAM_CAS_pin_function(void)
{
  DRCRB = DRCRB & ~0b00100000;
}

void set_DRAM_refresh_enable(void)
{
  DRCRB = DRCRB | 0b00010000;
}

void set_DRAM_precharge_cycle(void)
{
  DRCRB = DRCRB & ~0b00000100;
}

void set_DRAM_WR_wait_state(void)
{
  DRCRB = DRCRB & ~0b00000010;
}

void set_DRAM_refresh_wait_state(void)
{
  DRCRB = DRCRB & ~0b00000001;
}

void set_DRAM_area(void)
{
  DRCRA = DRCRA |  0b00100000;
  DRCRA = DRCRA & ~0b11000000;
}

void set_DRAM_burst_access(void)
{
  DRCRA = DRCRA & ~0b00001000;
}

void set_DRAM_self_refresh_mode_in_software_standby(void)
{
  /* このDRAMはセルフリフレッシュ非対応 */
  DRCRA = DRCRA & ~0b00000010;
}

void set_DRAM_RFSH_pin_function(void)
{
